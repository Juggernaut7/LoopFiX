...
router.post('/pools', [
  ...
  body('minStake')
    .isNumeric()
    .isInt({ min: 100000 })
    .withMessage('Minimum stake must be at least 100000 microSTX'),
  body('maxStake')
    .isNumeric()
    .isInt({ min: 100000 })
    .withMessage('Maximum stake must be at least 100000 microSTX'),
  body('walletAddress')
    .isString()
    .notEmpty()
...
router.post('/stakes', [
  ...
  body('amount')
    .isNumeric()
    .isInt({ min: 100000 })
    .withMessage('Amount must be at least 100000 microSTX'),
  body('walletAddress')
    .isString()
    .notEmpty()
    .withMessage('Wallet address is required'),
