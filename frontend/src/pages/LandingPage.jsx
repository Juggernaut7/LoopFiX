...
const LandingPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Deploy your savings goals as secure smart contracts on Stacks blockchain with automatic yield generation",
      color: "text-loopfund-coral-600"
    },
    {
      icon: Shield,
      title: "Bitcoin-Backed Security",
      description: "All operations secured by Bitcoin's network through Stacks Layer 2 for maximum security",
  ...
  const goalExamples = [
    { icon: Home, title: 'Home Down Payment', amount: '50 STX', type: 'individual', apy: '8.5%' },
    { icon: Car, title: 'New Car', amount: '25 STX', type: 'individual', apy: '12.3%' },
    { icon: BookOpen, title: 'Education Fund', amount: '15 STX', type: 'individual', apy: '15.7%' },
    { icon: Plane, title: 'Family Vacation', amount: '8 STX', type: 'group', apy: '10.2%' },
    { icon: Gift, title: 'Wedding Gift', amount: '5 STX', type: 'group', apy: '9.8%' },
    { icon: Heart, title: 'Emergency Fund', amount: '10 STX', type: 'individual', apy: '7.5%' }
  ];
  ...
  const testimonials = [
    ...
    },
    {
      name: 'David Chen',
      role: 'Crypto Native',
      content: 'Finally, a DeFi app that makes sense! The Bitcoin-backed security gives me confidence to earn yield safely.',
      avatar: 'DC',
      type: 'individual'
    }
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="font-body text-body-lg text-loopfund-neutral-600 dark:text-loopfund-neutral-400 leading-relaxed max-w-xl">
                  ...
                  Earn up to 15.7% APY through smart contracts on Stacks.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-display-xl text-white mb-6">
              Ready to Earn DeFi Yield on Bitcoin?
            </h2>
            <p className="font-body text-body-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Connect your Stacks wallet and start earning up to 15.7% APY through AI-optimized DeFi strategies 
